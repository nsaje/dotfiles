...
describe('zemFileInput', function () {
    ...
    beforeEach(inject(function ($compile, $rootScope) {
        element = $compile('<zem-file-input zem-file-input-callback="callback" zem-file-input-accept="image/*"><button zem-file-input-trigger></button></zem-file-input>/>')($rootScope);
