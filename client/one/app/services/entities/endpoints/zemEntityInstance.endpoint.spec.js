describe('zemEntityInstanceEndpoint', function () {
    ...
    it('should call correct UPDATE URLs', function () {
        zemEntityInstanceEndpoint.update(constants.entityType.ACCOUNT, 1, {settings: {}});
        zemEntityInstanceEndpoint.update(constants.entityType.CAMPAIGN, 1, {settings: {}, goals: {}});
        zemEntityInstanceEndpoint.update(constants.entityType.AD_GROUP, 1, {settings: {}});
