    ...
    .service('zemChartParser', function(
        ...
        var COLORS = angular.extend(
            ...
            ($window.zOne.whitelabel &&
                (overwrittes[$window.zOne.whitelabel.id] || {}).chartColors) ||
                {}
        );
        ...
        var getPointFormat = function(metric, currency) {
            ...
            return (
                valuePrefix + '{point.y:,.' + fractionSize + 'f}' + valueSuffix
            );
        };
        ...
        var getColor = function(chart, group) {
            ...
            if (!color) {
                usedColorIndexes = Object.keys(chart.legend.usedColors).map(
                    function(key) {
