angular.module('one.widgets').service('zemInfoboxEndpoint', function ($q, $http, zemDataFilterService, zemUtils) {
    ...
    function getInfoboxData (entity) {
        ...
        $http.get(url, {params: params})
            .then(function (data) {
                deferred.resolve(zemUtils.convertToCamelCase(data.data.data));
            })
    ...
    function constructGetInfoboxDataUrl (entityId, entityType) {
        switch (entityType) {
        case constants.entityType.AD_GROUP: return '/api/ad_groups/' + entityId + '/overview/';
        case constants.entityType.CAMPAIGN: return '/api/campaigns/' + entityId + '/overview/';
        case constants.entityType.ACCOUNT: return '/api/accounts/' + entityId + '/overview/';
        case null: return '/api/accounts/overview/';
        default: return '';
        }
    }
