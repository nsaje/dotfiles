angular.module('one.widgets').service('zemUploadService', function ($uibModal, $rootScope, zemUploadEndpointService) {
    ...
    function openEditModal (adGroupId, batchId, candidates, onSave) {
        ...
        var modal = $uibModal.open({
            template: '<zem-upload-step2 ad-group-id="adGroupId" callback="cb()" close="$close" ' +
