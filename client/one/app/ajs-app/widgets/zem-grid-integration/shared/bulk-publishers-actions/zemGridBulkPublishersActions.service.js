angular.module('one.widgets').service('zemGridBulkPublishersActionsService', function (zemDataFilterService, zemGridBulkPublishersActionsEndpoint, zemGridEndpointColumns, zemGridConstants, zemNavigationNewService, zemPermissions) { // eslint-disable-line max-len
    ...
    var BLACKLIST_ADGROUP = {
        ...
        hasPermission: zemPermissions.hasPermission('zemauth.can_modify_publisher_blacklist_status'),
    };
    var BLACKLIST_CAMPAIGN = {
        ...
        includeSubdomains: true,
        hasPermission: zemPermissions.hasPermission('zemauth.can_modify_publisher_blacklist_status') &&
            zemPermissions.hasPermission('zemauth.can_access_campaign_account_publisher_blacklist_status')
    };
    ...
    var BLACKLIST_GLOBAL = {
        ...
        status: constants.publisherTargetingStatus.BLACKLISTED,
        includeSubdomains: true,
        internal: zemPermissions.isPermissionInternal('zemauth.can_access_global_publisher_blacklist_status'),
        hasPermission: zemPermissions.hasPermission('zemauth.can_modify_publisher_blacklist_status') &&
            zemPermissions.hasPermission('zemauth.can_access_global_publisher_blacklist_status')
    };
