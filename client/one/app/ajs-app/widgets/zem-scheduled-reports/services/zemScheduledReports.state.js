angular.module('one.widgets').service('zemScheduledReportsStateService', function (zemScheduledReportsEndpoint, $q, $timeout, zemPermissions, zemReportScheduleService) { // eslint-disable-line max-len
    ...
    function formatReports (reports) {
        return reports.map(function (report) {
            ...
            if (report.frequency === 'WEEKLY') {
                dayOfWeek = zemReportScheduleService.MAPPING_DAYS_OF_WEEK[report.dayOfWeek];
            }
            return {
                id: report.id,
                name: report.name,
                ...
                level: report.level,
                dayOfWeek: dayOfWeek,
                frequency: zemReportScheduleService.MAPPING_FREQUENCIES[report.frequency],
                timePeriod: zemReportScheduleService.MAPPING_TIME_PERIODS[report.timePeriod],
