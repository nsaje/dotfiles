        ...
        return {
            ...
            link: function(scope, element) {
                ...
                function calculateNumOfRows() {
                    ...
                    var numOfRows = Math.ceil(
                        document.documentElement.clientHeight /
                            zemGridConstants.gridBodyRendering.ROW_HEIGHT
                    );
                    numOfRows = Math.max(
                        numOfRows,
                        zemGridConstants.gridBodyRendering
                            .MIN_NUM_OF_ROWS_PER_PAGE
                    );
                    return numOfRows;
                }
                ...
                function scrollWindowListener() {
                    NgZone.runOutsideAngular(function() {
                        var scrollTop = Math.max(
                            0,
                            window.pageYOffset - element.offset().top
                        );
                ...
                function updateVisibleRows() {
                    ...
                    scope.state.renderedRows = visibleRows.slice(
                        0,
                        grid.body.ui.numOfRows
                    );
                }
