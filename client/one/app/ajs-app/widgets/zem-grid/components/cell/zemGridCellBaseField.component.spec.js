describe('zemGridCellBaseField', function() {
    ...
    it("should display N/A if field's value is not defined", function() {
        ...
        expect(
            element
                .find('.zem-grid-cell-base-field__value')
                .text()
                .trim()
        ).toEqual('N/A');
    });
    ...
    it('should correctly display number values', function() {
        var tests = [
            ...
            {value: 0.1, fractionSize: 3, expectedResult: '0.100'},
        ];
    ...
    it('should correctly display number values with refunds', function() {
        var tests = [
            {value: 1234.5, refund_value: 123, expectedResult: '1,235 -123'},
            {
                value: 1234.56,
                refund_value: 123.45,
                fractionSize: 2,
                expectedResult: '1,234.56 -123.45',
            },
        ];
