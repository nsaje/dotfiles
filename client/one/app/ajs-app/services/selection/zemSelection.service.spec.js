describe('zemSelectionService', function() {
    ...
    it('getSelectedBatch should return batch id if batch is selected', function() {
        ...
        zemSelectionService.init();
        expect(zemSelectionService.getSelectedBatch()).toEqual(999);
    });
