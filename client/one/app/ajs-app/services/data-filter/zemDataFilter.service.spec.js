describe('zemDataFilterService', function () {
    ...
    it('should init correctly with url params', function () {
        spyOn($location, 'search').and.returnValue({
            ...
            filtered_statuses: zemDataFilterService.STATUSES_CONDITION_VALUES.archived,
        ...
        var dateRange = zemDataFilterService.getDateRange();
        expect(dateRange.startDate.valueOf()).toEqual(moment('2016-11-01').valueOf());
        expect(dateRange.endDate.valueOf()).toEqual(moment('2016-12-01').valueOf());

        var expectedConditions = {};
        expectedConditions[zemDataFilterService.CONDITIONS.sources.name] = ['1', '2'];
        expectedConditions[zemDataFilterService.CONDITIONS.agencies.name] = ['3', '4'];
        expectedConditions[zemDataFilterService.CONDITIONS.accountTypes.name] = ['5', '6'];
        expectedConditions[zemDataFilterService.CONDITIONS.statuses.name] = [zemDataFilterService.STATUSES_CONDITION_VALUES.archived]; // eslint-disable-line max-len
        expectedConditions[zemDataFilterService.CONDITIONS.publisherStatus.name] = zemDataFilterService.PUBLISHER_STATUS_CONDITION_VALUES.active; // eslint-disable-line max-len
        expect(zemDataFilterService.getAppliedConditions()).toEqual(expectedConditions);
    });
    ...
    it('should correctly set date range', function () {
        ...
        expect(updatedDateRange.startDate.valueOf()).toEqual(dateRange.startDate.valueOf());
        expect(updatedDateRange.endDate.valueOf()).toEqual(dateRange.endDate.valueOf());
    });
    ...
    it('should correctly apply conditions', function () {
        ...
        var expectedConditions = {};
        expectedConditions[zemDataFilterService.CONDITIONS.sources.name] = ['1'];
        expectedConditions[zemDataFilterService.CONDITIONS.agencies.name] = ['2', '3'];
        expectedConditions[zemDataFilterService.CONDITIONS.accountTypes.name] = ['4', '5', '6'];
        expectedConditions[zemDataFilterService.CONDITIONS.statuses.name] = [zemDataFilterService.STATUSES_CONDITION_VALUES.archived]; // eslint-disable-line max-len
        expectedConditions[zemDataFilterService.CONDITIONS.publisherStatus.name] = zemDataFilterService.PUBLISHER_STATUS_CONDITION_VALUES.blacklisted; // eslint-disable-line max-len
        expect(zemDataFilterService.getAppliedConditions()).toEqual(expectedConditions);
        expect($location.search()).toEqual({
            ...
            filtered_statuses: zemDataFilterService.STATUSES_CONDITION_VALUES.archived,
            filtered_publisher_status: zemDataFilterService.PUBLISHER_STATUS_CONDITION_VALUES.blacklisted,
        });
    });
    ...
    it('should reset condition to its default value', function () {
        ...
        expect($location.search()).toEqual({
            filtered_publisher_status: zemDataFilterService.PUBLISHER_STATUS_CONDITION_VALUES.all,
        });
    });
