...
angular
    .module('one.services')
    .service('zemDesignHelpersService', function($window) {
        this.init = init;
        ...
        function init() {
            ...
            var hasWhitelabel = commonHelpers.isDefined(
            ...
            if (commonHelpers.isDefined(sidebarContainerContentElement)) {
                $(sidebarContainerContentElement).scroll(function() {
                    if ($(this).scrollTop() >= 600) {
                        ...
                        $('.scroll-to-top').removeClass(
                            'scroll-to-top--visible'
                        );
                    }
                });
                $('.scroll-to-top').click(function() {
                    $(sidebarContainerContentElement).animate(
                        {scrollTop: 0},
                        500
                    );
                });
