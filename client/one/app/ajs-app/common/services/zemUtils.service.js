angular.module('one.services').service('zemUtils', function($q) {
    ...
    function convertToCamelCase(obj) {
        ...
        Object.keys(obj).forEach(function(key) {
            var convertedKey = key.replace(/(_[a-z])/g, function($1) {
    ...
    function convertToElementName(componentName) {
        ...
        var tagName = componentName.replace(/([A-Z])/g, function($1) {
