describe('component: zemColumnSelector', function () {
    ...
    it('shows tooltip msg when column is disabled', function () {
        ...
        expect(response).toEqual('Column is available when corresponding breakdown is visible.');
    });
    ...
    function generatedCategories () {
        return [
            ...
            {name: 'another Category name', columns: generateColumns2(), subcategories: generateSubcategories()},
        ];
    }
    ...
    function generateColumns () {
        return [
            {data: {name: 'column1', field: 'c1'}, visible: true, disabled: true},
            {data: {name: 'column2', field: 'c2'}, visible: true, disabled: false},
            {data: {name: 'column3', field: 'c3'}, visible: true, disabled: false},
            {data: {name: 'column4', field: 'c4'}, visible: false, disabled: false},
            {data: {name: 'column5', field: 'c5'}, visible: false, disabled: true},
        ];
    }

    function generateColumns2 () {
        return [
            {data: {name: 'column6', field: 'c6'}, visible: true, disabled: true},
            {data: {name: 'column7', field: 'c7'}, visible: true, disabled: false},
            {data: {name: 'column8', field: 'c8'}, visible: true, disabled: false},
            {data: {name: 'column9', field: 'c9'}, visible: false, disabled: false},
        ];
    }
});
