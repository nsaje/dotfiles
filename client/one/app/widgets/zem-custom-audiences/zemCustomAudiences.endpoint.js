angular.module('one.widgets').service('zemCustomAudiencesEndpoint', function ($q, $http, zemUtils) { //eslint-disable-line max-len
            ...
            success(function (data) {
                ...
                if (data && data.data) {
                    resource = data.data.map(function (d) {
                        ...
                        converted.createdDt = moment(converted.createdDt).toDate();
                        return converted;
                    });
                }
