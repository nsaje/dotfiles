    ...
    var COLUMNS = {
        ...
        avgCostPerPageview: {
            ...
            help: '<p>The average cost per pageview on your site. ' +
                  ...
                  '<p>The metric is calculated as the total amount of pageviews divided by total cost.</p>',
            totalRow: true,
            order: true,
            initialOrder: zemGridConstants.gridColumnOrder.DESC,
            goal: true,
        ...
        avgCostPerVisit: {
            ...
            help: '<p>The average cost per visit to your site. Only visits generated by ' +
                  ...
                  '<p>Visits are detected by your analytics software (Google Analytics or Adobe Omniture) as ' +
                  'opposed to clicks, which are detected by Zemanta. ' +
                  'They provide a better insight into the value of traffic sent by Zemanta.</p>' +
                  '<p>The metric is calculated as the total amount of visits divided by total cost.</p>',
            totalRow: true,
            order: true,
            initialOrder: zemGridConstants.gridColumnOrder.DESC,
            goal: true,
