...
describe('zemGridEndpointColumnsSpec', function () {
    ...
    it('should brand permanent columns', function () {
        var columns = zemGridEndpointColumns.createColumns(constants.level.CAMPAIGNS,
    ...
    it('should create columns based on breakdown', function () {
        var columns = zemGridEndpointColumns.createColumns(constants.level.ALL_ACCOUNTS,
    ...
    it('should set dynamic columns correctly', function () {
        var columns = zemGridEndpointColumns.createColumns(constants.level.CAMPAIGNS, [constants.breakdown.AD_GROUP]);
