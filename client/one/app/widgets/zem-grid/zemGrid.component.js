...
angular.module('one.widgets').component('zemGrid', {
    ...
    controller: function ($scope, $element, zemPermissions, zemGridObject, zemGridPubSub, zemGridDataService, zemGridColumnsService, zemGridOrderService, zemGridSelectionService, zemGridCollapseService, zemGridApi) { // eslint-disable-line max-len
        ...
        this.$onInit = function () {
            ...
            $ctrl.grid.meta.dataService = zemGridDataService.createInstance(this.grid, this.dataSource);
            $ctrl.grid.meta.options = this.options || {};

            // Extensions
            $ctrl.grid.meta.columnsService = zemGridColumnsService.createInstance(this.grid);
            $ctrl.grid.meta.orderService = zemGridOrderService.createInstance(this.grid);
            $ctrl.grid.meta.collapseService = zemGridCollapseService.createInstance(this.grid);
            $ctrl.grid.meta.selectionService = zemGridSelectionService.createInstance(this.grid);
            ...
            $ctrl.grid.meta.api.isPermissionInternal = zemPermissions.isPermissionInternal;
