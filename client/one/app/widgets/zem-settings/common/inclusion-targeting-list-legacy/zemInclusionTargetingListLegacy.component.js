angular.module('one.widgets').component('zemInclusionTargetingListLegacy', {
    bindings: {
        texts: '<',
        targetings: '<',
        addTargeting: '&',
    ...
    templateUrl: '/app/widgets/zem-settings/common/inclusion-targeting-list-legacy/zemInclusionTargetingListLegacy.component.html',  // eslint-disable-line max-len
    controller: function () {
        var $ctrl = this;
