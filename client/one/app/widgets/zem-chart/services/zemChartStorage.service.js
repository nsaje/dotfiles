angular.module('one').service('zemChartStorageService', function (zemLocalStorageService, zemNavigationNewService) {
    ...
    function loadMetrics (level) {
        var accountKey = getAccountKey(level, zemNavigationNewService.getActiveAccount());
        var storedMetrics = zemLocalStorageService.get(KEY_METRICS, LOCAL_STORAGE_NAMESPACE) || {};
    ...
    function saveMetrics (metrics, level) {
        ...
        zemLocalStorageService.set(KEY_METRICS, storedMetrics, LOCAL_STORAGE_NAMESPACE);
    }
