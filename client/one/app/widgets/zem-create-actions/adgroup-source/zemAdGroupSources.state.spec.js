describe('state: zemAdGroupSourcesStateService', function () {
    ...
    it('should prepare state object', function () {
        ...
        expect(stateService.getState()).toEqual({sources: [], requests: jasmine.any(Object)});
    });
    ...
    describe('state service actions', function () {
        ...
        it('should use endpoint service for creation', function () {
            ...
            expect(zemAdGroupSourcesEndpoint.create).toHaveBeenCalledWith(-1, 1);
        });
        it('should use endpoint for list', function () {
            stateService.list(1);
            expect(zemAdGroupSourcesEndpoint.list).toHaveBeenCalledWith(-1, {filteredSources: []});
        });
