...
//
angular.module('one.widgets').controller('zemDownloadExportReportModalCtrl', function ($scope, $window, $state, zemDataFilterService, zemDownloadExportReportModalEndpoint) {  // eslint-disable-line max-len
    ...
    $scope.setDisabledExportOptions = function () {
        ...
        zemDownloadExportReportModalEndpoint.get($state.params.id, $scope.level,
...
angular.module('one.widgets').service('zemDownloadExportReportModalEndpoint', function ($q, $http, zemDataFilterService) { // eslint-disable-line max-len
