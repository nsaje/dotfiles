import './credits-legacy.view.less';
...
@Component({
    selector: 'zem-credits-legacy-view',
    templateUrl: './credits-legacy.view.html',
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class CreditsLegacyView implements OnInit, OnDestroy {
    @HostBinding('class')
