...
export class BigNumberPipe implements PipeTransform {
    transform (value: number): string {
        ...
        } else if (abs < Math.pow(10, 12) && abs >= Math.pow(10, 9)) { // tslint:disable-line
            return (value / Math.pow(10, 9)).toFixed() + ' B'; // tslint:disable-line
        } else if (abs < Math.pow(10, 9) && abs >= Math.pow(10, 6)) { // tslint:disable-line
            return (value / Math.pow(10, 6)).toFixed() + ' M'; // tslint:disable-line
        } else if (abs < Math.pow(10, 6) && abs >= Math.pow(10, 3)) { // tslint:disable-line
