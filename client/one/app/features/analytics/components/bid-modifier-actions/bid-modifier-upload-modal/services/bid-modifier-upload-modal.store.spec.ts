...
import {BidModifierUploadModalStore} from './bid-modifier-upload-modal.store';
import {Breakdown} from '../../../../../../app.constants';
import {fakeAsync, tick} from '@angular/core/testing';
import {of, throwError} from 'rxjs';

describe('BidModifierUploadModalStore', () => {
    let serviceStub: jasmine.SpyObj<BidModifiersService>;
    let store: BidModifierUploadModalStore;
    ...
    beforeEach(() => {
        ...
        store = new BidModifierUploadModalStore(serviceStub);
