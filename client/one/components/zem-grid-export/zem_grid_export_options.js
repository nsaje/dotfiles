...
oneApp.factory('zemGridExportOptions', [function () {
    ...
    //
    var OPTIONS = {
        allAccounts: {name: 'By All Accounts', value: constants.exportType.ALL_ACCOUNTS},
        ...
        contentAd: {name: 'By Content Ad', value: constants.exportType.CONTENT_AD},
    };
    ...
    function getOptionsByLevel (level) {
        switch (level) {
        case constants.level.ALL_ACCOUNTS: return ALL_ACCOUNTS_LEVEL_OPTIONS;
        case constants.level.ACCOUNTS: return ACCOUNTS_LEVEL_OPTIONS;
        case constants.level.CAMPAIGNS: return CAMPAIGNS_LEVEL_OPTIONS;
        case constants.level.AD_GROUPS: return AD_GROUPS_LEVEL_OPTIONS;
        }
    }

    function getOptions (level, breakdown) {
        if (breakdown === constants.breakdown.PUBLISHER) throw 'Export by publisher breakdown is not supported';
