...
angular.module('one.legacy').directive('zemGrid', [function () {
    return {
        ...
        controller: ['$scope', '$element', 'zemGridObject', 'zemGridPubSub', 'zemGridDataService', 'zemGridColumnsService', 'zemGridOrderService', 'zemGridSelectionService', 'zemGridCollapseService', 'zemGridNotificationService', 'zemGridApi', function ($scope, $element, zemGridObject, zemGridPubSub, zemGridDataService, zemGridColumnsService, zemGridOrderService, zemGridSelectionService, zemGridCollapseService, zemGridNotificationService, zemGridApi) { // eslint-disable-line max-len
