...
oneApp.controller('AdGroupSourcesCtrl', ['$scope', '$state', '$location', '$window', '$timeout', 'api', 'zemCustomTableColsService', 'zemPostclickMetricsService', 'zemChartService', 'localStorageService', function ($scope, $state, $location, $window, $timeout, api, zemCustomTableColsService, zemPostclickMetricsService, zemChartService, localStorageService) {
    ...
    $scope.columns = [
        ...
        },
        {
            ...
            visible: $scope.hasPermission('zemauth.set_ad_group_source_settings'),
            checked: true,
            totalRow: false,
            unselectable: true,
        ...
        },
        {
            ...
            visible: $scope.hasPermission('zemauth.supply_dash_link_view'),
            totalRow: true,
            order: true,
            initialOrder: 'desc'
        },
        ...
        },
        {
            ...
            visible: $scope.hasPermission('zemauth.see_current_ad_group_source_state'),
            totalRow: false,
            order: true,
        ...
        },
        {
            ...
            visible: $scope.hasPermission('reports.yesterday_spend_view'),
            totalRow: true,
            order: true,
            initialOrder: 'desc'
        },
