...
angular.module('one.legacy').controller('AccountCtrl', function ($scope, $state, zemNavigationService, accountData) {
    ...
    $scope.getTabs = function () { // eslint-disable-line
        return [
            ...
            {heading: 'Pixels & Audiences', route: 'main.accounts.customAudiences', active: false, hidden: !$scope.hasPermission('zemauth.account_custom_audiences_view') || $scope.hasPermission('zemauth.can_see_new_pixels_view'), internal: $scope.isPermissionInternal('zemauth.account_custom_audiences_view')},
