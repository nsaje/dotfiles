...
oneApp.controller('AccountCtrl', ['$scope', '$state', function ($scope, $state) {
    ...
    $scope.getTabs = function () {
        return [
            ...
            {heading: 'Settings', route: 'main.accounts.account', active: false, hidden: !$scope.hasPermission('zemauth.account_account_view') || ($scope.hasPermission('zemauth.view_archived_entities') && $scope.account && $scope.account.archived), internal: $scope.isPermissionInternal('zemauth.account_account_view')},
