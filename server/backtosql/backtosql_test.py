...
class ModelTestCase(TestCase):
    ...
    def test_get_columns(self):
        self.assertCountEqual(self.ModelA().get_columns(),
    ...
    def test_select_columns(self):
        ...
        self.assertCountEqual(m.select_columns(subset=['py_foo', 'py_bar']),
                              [m.py_foo, m.py_bar])

        self.assertCountEqual(m.select_columns(group=1),
                              [m.py_foo, m.py_cat])

        self.assertCountEqual(m.select_columns(subset=['py_foo', 'py_bar'], group=1),
                              [m.py_foo])
        ...
        with self.assertRaises(backtosql.BackToSQLException):
            ...
            self.assertCountEqual(m.select_columns(subset=['nonexistent']),
                                  [m.py_foo])
    ...
    def test_add_column(self):
        ...
        self.assertCountEqual(m.select_columns(subset=['py_foo', 'py_bar', 'food']),
