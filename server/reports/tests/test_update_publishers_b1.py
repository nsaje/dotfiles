...
class CommandUpdatePublishersTest(TestCase):
    ...
    def test_handle(self, s3helper_list_mock, insert_publishers_mock, delete_publishers_mock):
        ...
        insert_publishers_mock.assert_called_with(
            's3://%s/publishers/2015-12-29-2015-12-31--1451296802070761934/part-00000' % settings.S3_BUCKET_STATS,
