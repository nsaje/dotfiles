...
class GaContentAdReportTest(test.TestCase):
    ...
    sample_data = json.loads("""[
        {
            ...
            "ga_report": {
                ...
                "Landing Page": "/lasko?_z1_adgid=1&_z1_msid=lasko",
                "New Users": "531",
                "Pages / Session": "1.12",
                "Sessions": "553",
    ...
    def test_post(self):
        request = self.rf.post('reports/ga/contentadstats', data=GaContentAdReportTest.sample_data, content_type='application/json')
