...
from reports.rs_helpers import sum_div, sum_agr, unchanged, from_cc, mul_expr, \
...
class RSContentAdStatsModel(redshift.RSModel):
    ...
    _POSTCLICK_ENGAGEMENT_FIELDS = [
        ...
        dict(sql='new_users_sum',         app='new_users',          out=unchanged,                calc=rsh.sum_agr('new_visits')),
