...
class FilterTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.public_fields = {
            ...
            'avg_cost_per_pixel_1_168', 'local_avg_cost_per_pixel_1_168', 'avg_cost_per_pixel_1_2160', 'local_avg_cost_per_pixel_1_2160',
            'avg_cost_per_pixel_1_24', 'local_avg_cost_per_pixel_1_24', 'avg_cost_per_pixel_1_720', 'local_avg_cost_per_pixel_1_720',
            'pixel_1_168', 'pixel_1_2160', 'pixel_1_24', 'pixel_1_720',
            'roas_pixel_1_168', 'roas_pixel_1_2160', 'roas_pixel_1_24', 'roas_pixel_1_720',
            'video_cpcv', 'local_video_cpcv', 'video_cpv', 'local_video_cpv',
            'video_complete', 'video_first_quartile', 'video_midpoint', 'video_playback_method', 'video_progress_3s', 'video_start', 'video_third_quartile',
            'agency_cost', 'local_agency_cost',
            'total_fee_projection', 'total_fee', 'flat_fee',
            'margin', 'local_margin',
        }
        ...
        self.public_fields |= {
            'e_data_cost', 'local_e_data_cost', 'e_media_cost', 'local_e_media_cost', 'e_yesterday_cost', 'local_e_yesterday_cost',
            'et_cost', 'local_et_cost',
            'avg_et_cost_per_visit', 'local_avg_et_cost_per_visit', 'avg_et_cost_for_new_visitor', 'local_avg_et_cost_for_new_visitor',
            'avg_et_cost_per_minute', 'local_avg_et_cost_per_minute', 'avg_et_cost_per_non_bounced_visit', 'local_avg_et_cost_per_non_bounced_visit',
            'avg_et_cost_per_pageview', 'local_avg_et_cost_per_pageview', 'avg_et_cost_per_pixel_1_168', 'local_avg_et_cost_per_pixel_1_168',
            'avg_et_cost_per_pixel_1_2160', 'local_avg_et_cost_per_pixel_1_2160', 'avg_et_cost_per_pixel_1_24', 'local_avg_et_cost_per_pixel_1_24',
            'avg_et_cost_per_pixel_1_720', 'local_avg_et_cost_per_pixel_1_720',
            'et_cpc', 'local_et_cpc', 'et_cpm', 'local_et_cpm',
            'et_roas_pixel_1_168', 'et_roas_pixel_1_2160', 'et_roas_pixel_1_24', 'et_roas_pixel_1_720',
            'license_fee', 'local_license_fee', 'license_fee_projection', 'pacing', 'spend_projection',
            'video_et_cpcv', 'local_video_et_cpcv', 'video_et_cpv', 'local_video_et_cpv',
    ...
    def test_filter_columns_by_permission_actual_cost(self):
        ...
        self.assertCountEqual(set(rows[0].keys()) - self.public_fields, [
            'data_cost', 'local_data_cost', 'yesterday_cost', 'local_yesterday_cost', 'at_cost', 'local_at_cost',
            'media_cost', 'local_media_cost', 'yesterday_at_cost', 'local_yesterday_at_cost',
        ])
    ...
    def test_filter_columns_by_permission_actual_cost_bcm_v2(self):
        ...
        self.assertCountEqual(set(rows[0].keys()) - self.public_fields_uses_bcm_v2, [
            'data_cost', 'local_data_cost', 'at_cost', 'local_at_cost', 'media_cost', 'local_media_cost',
    ...
    def test_filter_columns_by_permission_platform_cost_bcm_v2(self):
        ...
        self.assertCountEqual(set(rows[0].keys()) - self.public_fields_uses_bcm_v2, [
            'avg_et_cost_for_new_visitor', 'local_avg_et_cost_for_new_visitor', 'avg_et_cost_per_minute', 'local_avg_et_cost_per_minute',
            'avg_et_cost_per_non_bounced_visit', 'local_avg_et_cost_per_non_bounced_visit', 'avg_et_cost_per_pageview', 'local_avg_et_cost_per_pageview',
            'avg_et_cost_per_pixel_1_168', 'local_avg_et_cost_per_pixel_1_168', 'avg_et_cost_per_pixel_1_2160', 'local_avg_et_cost_per_pixel_1_2160',
            'avg_et_cost_per_pixel_1_24', 'local_avg_et_cost_per_pixel_1_24', 'avg_et_cost_per_pixel_1_720', 'local_avg_et_cost_per_pixel_1_720',
            'avg_et_cost_per_visit', 'local_avg_et_cost_per_visit',
            'e_data_cost', 'local_e_data_cost', 'e_media_cost', 'local_e_media_cost',
            'et_roas_pixel_1_168', 'et_roas_pixel_1_2160', 'et_roas_pixel_1_24', 'et_roas_pixel_1_720',
            'license_fee', 'local_license_fee',
            'license_fee_projection', 'pacing', 'spend_projection'])
    ...
    def test_filter_columns_by_permission_platform_cost_derived_bcm_v2(self):
        ...
        self.maxDiff = None
        self.assertCountEqual(set(rows[0].keys()) - self.public_fields_uses_bcm_v2, [
            'et_cost', 'local_et_cost', 'et_cpc', 'local_et_cpc', 'et_cpm', 'local_et_cpm',
            'video_et_cpcv', 'local_video_et_cpcv', 'video_et_cpv', 'local_video_et_cpv',
            'yesterday_et_cost', 'local_yesterday_et_cost',
        ])
    ...
    def test_filter_columns_by_permission_campaign_goal_optimization(self):
        ...
        self.assertCountEqual(set(rows[0].keys()) - self.public_fields, [
            'avg_cost_per_conversion_goal_2', 'local_avg_cost_per_conversion_goal_2', 'avg_cost_per_conversion_goal_3', 'local_avg_cost_per_conversion_goal_3',
            'avg_cost_per_conversion_goal_4', 'local_avg_cost_per_conversion_goal_4', 'avg_cost_per_conversion_goal_5', 'local_avg_cost_per_conversion_goal_5',
            'avg_et_cost_per_conversion_goal_2', 'local_avg_et_cost_per_conversion_goal_2', 'avg_et_cost_per_conversion_goal_3', 'local_avg_et_cost_per_conversion_goal_3',
            'avg_et_cost_per_conversion_goal_4', 'local_avg_et_cost_per_conversion_goal_4', 'avg_et_cost_per_conversion_goal_5', 'local_avg_et_cost_per_conversion_goal_5',
        ])
