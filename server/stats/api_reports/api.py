...
UNABLE_TO_SORT = (
    'campaign', 'brand_name', 'bid_cpc', 'batch_name', 'source', 'blacklisted_level', 'content_ad', 'account_type',
    'salesforce_url', 'content_ad_status', 'flat_fee', 'source_slug', 'account', 'ad_group_status', 'daily_budget',
    'call_to_action', 'default_cs_representative', 'placement_type', 'image_url', 'tracker_urls',
    'publisher_status', 'account_status', 'video_playback_method', 'upload_time', 'domain_link', 'agency', 'label',
