...
FIELD_PERMISSION_MAPPING = {
    ...
    "ob_representative": ("zemauth.can_see_managers_in_accounts_table",),
...
def validate_breakdown_by_permissions(level, user, breakdown):
    ...
    if level == Level.ALL_ACCOUNTS:
        ...
        if base_dimension not in (StructureDimension.SOURCE, StructureDimension.CAMPAIGN, StructureDimension.PUBLISHER):
            raise exc.MissingDataError()
