...
class Command(utils.command_helpers.ExceptionCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument("--where", dest="where", default=None, help="Additional WHERE clause")
        parser.add_argument("--daily", dest="monthly", action="store_true", help="Average daily")
        parser.add_argument("--blacklisted", dest="blacklisted", action="store_true", help="Blacklisted impressions")
        parser.add_argument("--days", dest="days", default=30, type=int, help="Days in past to check (default last 30)")
    ...
    def handle(self, *args, **options):
        ...
        query = (
            ...
            pubs=(" AND publisher IN (" + ", ".join("'{}'".format(pub) for pub in publishers) + ")")
            if publishers
            else "",
            where=where,
        ...
        self.stdout.write("Report: {}\n".format(prodops.helpers.generate_report_from_query(options["name"], query)))
