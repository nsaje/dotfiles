...
class Command(utils.command_helpers.ExceptionCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--error", dest="is_error", action="store_true", help="Error"
        )
        parser.add_argument(
            "--warn", dest="is_warning", action="store_true", help="Warning"
        )
        parser.add_argument(
            "--success", dest="is_success", action="store_true", help="Success"
        )
    ...
    def handle(self, *args, **options):
        ...
        utils.slack.publish(
            options.get("msg") or sys.stdin.read(),
            msg_type=msg_type,
            username="Slack command",
        )
