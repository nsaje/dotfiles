...
class ConstructRedirectorURLTestCase(TestCase):
    ...
    def test_construct_redirector_url(self):
        ...
        expected = "http://r1-usc1.zemanta.com/rp2/{sourceDomain}/1/2/" + encrypted_data + "/"
        ...
        expected = "http://r1-usc1.zemanta.com/rp2/{sourceDomain}/1/2/" + encrypted_data + "/?key1=val1"
        self.assertEqual(result, expected)
    ...
    def test_construct_redirector_url_encrypted_content(self):
        ...
        expected = "http://r1-usc1.zemanta.com/rp2/{sourceDomain}/1/2/SVNB33U7NNUFZSRPQRD4J7VEHPMHDSJE27JLSPLF23EBARCFZ6FSOWIMG6SOJXASYJKUQ67ZTNVZ6/"
        self.assertEqual(result, expected)
    ...
    def test_construct_redirector_url_adtags(self):
        ...
        expected = "http://r1-usc1.zemanta.com/rp2/{sourceDomain}/1/2/" + encrypted_data + "/?rurl="
        self.assertEqual(result, expected)
    ...
    def test_construct_redirector_url_for_outbrain(self):
        ...
        expected = (
            "http://r1-usc1.zemanta.com/rp2/{sourceDomain}/1/2/" + encrypted_data + "/?_r_outbrainpubid=%24%7BPUBID%7D"
        )
        self.assertEqual(result, expected)
