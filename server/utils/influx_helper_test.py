...
class CleanPathTestCase(TestCase):
    ...
    def test_uuid(self):
        self.assertEqual(
            "/videoassets/_UUID_/", influx_helper.clean_path("/videoassets/dd82ec82-f72b-4280-a273-8557e3034f16/")
        )
    ...
    def test_token(self):
        self.assertEqual(
            "/set_password/_TOKEN_/", influx_helper.clean_path("/set_password/MTM2MA-5ry-324dc45159f323fab67f/")
        )
