...
class ColumnNamesTest(TestCase):
    ...
    def test_get_pixel_field_names_mapping(self):
        ...
        self.assertDictEqual(
            columns._get_pixel_field_names_mapping(dash.models.ConversionPixel.objects.all(), uses_bcm_v2=False),
            {
                ...
                "CPA (Test 1 day - Click attr.)": "avg_cost_per_pixel_1_24",
                "ROAS (Test 1 day - Click attr.)": "roas_pixel_1_24",
                "Test 7 days - Click attr.": "pixel_1_168",
                "Conversion rate (Test 7 days - Click attr.)": "conversion_rate_per_pixel_1_168",
                "CPA (Test 7 days - Click attr.)": "avg_cost_per_pixel_1_168",
                "ROAS (Test 7 days - Click attr.)": "roas_pixel_1_168",
                "Test 30 days - Click attr.": "pixel_1_720",
                "Conversion rate (Test 30 days - Click attr.)": "conversion_rate_per_pixel_1_720",
                "CPA (Test 30 days - Click attr.)": "avg_cost_per_pixel_1_720",
                "ROAS (Test 30 days - Click attr.)": "roas_pixel_1_720",
                "Test 90 days - Click attr.": "pixel_1_2160",
                "Conversion rate (Test 90 days - Click attr.)": "conversion_rate_per_pixel_1_2160",
                "CPA (Test 90 days - Click attr.)": "avg_cost_per_pixel_1_2160",
                "ROAS (Test 90 days - Click attr.)": "roas_pixel_1_2160",
                "Test 1 day - View attr.": "pixel_1_24_view",
                "Conversion rate (Test 1 day - View attr.)": "conversion_rate_per_pixel_1_24_view",
                "CPA (Test 1 day - View attr.)": "avg_cost_per_pixel_1_24_view",
                "ROAS (Test 1 day - View attr.)": "roas_pixel_1_24_view",
                "Test 7 days - View attr.": "pixel_1_168_view",
                "Conversion rate (Test 7 days - View attr.)": "conversion_rate_per_pixel_1_168_view",
                "CPA (Test 7 days - View attr.)": "avg_cost_per_pixel_1_168_view",
                "ROAS (Test 7 days - View attr.)": "roas_pixel_1_168_view",
                "Test 30 days - View attr.": "pixel_1_720_view",
                "Conversion rate (Test 30 days - View attr.)": "conversion_rate_per_pixel_1_720_view",
                "CPA (Test 30 days - View attr.)": "avg_cost_per_pixel_1_720_view",
                "ROAS (Test 30 days - View attr.)": "roas_pixel_1_720_view",
            },
        )

    def test_get_conversion_goals_field_names_mapping(self):
        self.assertDictEqual(
            columns._get_conversion_goals_field_names_mapping(
                dash.models.ConversionGoal.objects.all(), uses_bcm_v2=False
            ),
            {
