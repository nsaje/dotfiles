...
class UpdateExchangeRatesTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.ad_group.settings.update(
            request, skip_automation=True, skip_validation=True,
            local_cpc_cc='0.8', local_autopilot_daily_budget=100,
            local_b1_sources_group_daily_budget=72,
            local_b1_sources_group_cpc_cc='0.35', local_max_cpm='1.3')
        ...
        self.ad_group_source.settings.update(
            request, k1_sync=False, skip_automation=True, skip_validation=True,
