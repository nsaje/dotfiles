...
class EntityTagHelpersTestCase(test.TestCase):
    ...
    def test_tag_query_set_to_string_no_tags(self):
        self.assertEqual(helpers.entity_tag_query_set_to_string(model.EntityTag.objects.none()), "")

    def test_tag_query_set_to_string_with_tags(self):
        self.assertEqual(helpers.entity_tag_query_set_to_string(model.EntityTag.objects.all()), self.expected_string)
