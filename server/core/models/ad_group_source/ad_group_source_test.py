...
class AdGroupSourceCreate(TestCase):
    def setUp(self):
        ...
        self.default_source_settings = magic_mixer.blend(
            core.models.DefaultSourceSettings, source__maintenance=False, credentials=magic_mixer.RANDOM
        )
        self.ad_group = magic_mixer.blend(
            core.models.AdGroup, campaign__account__allowed_sources=[self.default_source_settings.source]
        )

    def test_create(self, mock_k1):
        ad_group_source = core.models.AdGroupSource.objects.create(
        ...
        ad_group_source_settings = core.models.settings.AdGroupSourceSettings.objects.filter(
    ...
    def test_create_already_exists(self, mock_k1):
        magic_mixer.blend(core.models.AdGroupSource, ad_group=self.ad_group, source=self.default_source_settings.source)
    ...
    def test_create_ad_review_only_already_exists(self, mock_autopilot, mock_k1):
        ...
        ad_group_source = core.models.AdGroupSource.objects.get()
...
class AdGroupSourceClone(TestCase):
    ...
    def test_clone(self, mock_k1):
        source_ad_group_source = magic_mixer.blend(
            core.models.AdGroupSource, source=magic_mixer.blend_source_w_defaults()
        )
        ...
        ad_group_source = core.models.AdGroupSource.objects.clone(
