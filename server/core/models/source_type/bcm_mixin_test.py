...
class GetEtfmLimitsTestCase(TestCase):
    def setUp(self):
        ...
        self.bcm_modifiers = {
            "service_fee": decimal.Decimal("0.10"),
    ...
    def test_get_etfm_min_cpc_with_bcm_modifiers(self):
        self.assertEqual(decimal.Decimal("0.059"), self.source_type.get_etfm_min_cpc(self.bcm_modifiers))
    ...
    def test_get_etfm_max_cpc_with_bcm_modifiers(self):
        self.assertEqual(decimal.Decimal("19.510"), self.source_type.get_etfm_max_cpc(self.bcm_modifiers))
    ...
    def test_get_etfm_min_cpm_with_bcm_modifiers(self):
        self.assertEqual(decimal.Decimal("0.059"), self.source_type.get_etfm_min_cpm(self.bcm_modifiers))
    ...
    def test_get_etfm_max_cpm_with_bcm_modifiers(self):
        self.assertEqual(decimal.Decimal("19.510"), self.source_type.get_etfm_max_cpm(self.bcm_modifiers))
    ...
    def test_get_etfm_min_daily_budget_with_bcm_modifiers(self):
        self.assertEqual(decimal.Decimal("20"), self.source_type.get_etfm_min_daily_budget(self.bcm_modifiers))
    ...
    def test_get_etfm_max_daily_budget_with_bcm_modifiers(self):
        self.assertEqual(decimal.Decimal("1951"), self.source_type.get_etfm_max_daily_budget(self.bcm_modifiers))
