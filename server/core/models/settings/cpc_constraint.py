...
class CpcConstraint(models.Model):
    ...
    agency = models.ForeignKey(
        core.models.Agency, null=True, blank=True, related_name="cpc_constraints", on_delete=models.PROTECT
    )
    account = models.ForeignKey(
        core.models.Account, null=True, blank=True, related_name="cpc_constraints", on_delete=models.PROTECT
    )
    campaign = models.ForeignKey(
        core.models.Campaign, null=True, blank=True, related_name="cpc_constraints", on_delete=models.PROTECT
    )
    ad_group = models.ForeignKey(
        core.models.AdGroup, null=True, blank=True, related_name="cpc_constraints", on_delete=models.PROTECT
    )
    source = models.ForeignKey(
        core.models.Source, null=True, blank=True, related_name="cpc_constraints", on_delete=models.PROTECT
    )
