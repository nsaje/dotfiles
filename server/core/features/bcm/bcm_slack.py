...
SLACK_NEW_CREDIT_WITHOUT_CONTRACT_MSG = "<!channel> New credit #{credit_id} added on account <{url}|{account_name}> with amount {currency_symbol}{amount} and end date {end_date} has been created without contract ID or contract Number!"
