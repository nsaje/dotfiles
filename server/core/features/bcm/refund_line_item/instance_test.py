...
class RefundLineItemInstanceMixinTest(TestCase):
    def test_save_history(self):
        ...
        self.assertEqual(1, core.features.bcm.RefundHistory.objects.count())
        ...
        self.assertEqual(expected_history, core.features.bcm.RefundHistory.objects.latest("created_dt").snapshot)
        self.assertEqual(
        ...
        self.assertEqual(2, core.features.bcm.RefundHistory.objects.count())
