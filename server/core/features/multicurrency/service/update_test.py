...
class UpdateExchangeRatesTestCase(TestCase):
    ...
    def test_initial_settings(self):
        ...
        self.assertEqual(decimal.Decimal("1"), self.ad_group.settings.b1_sources_group_cpc_cc)
    ...
    def test_update_exchange_rates(self, mock_get_exchange_rates):
        ...
        self.assertEqual(decimal.Decimal("1.0667"), self.ad_group.settings.b1_sources_group_cpc_cc)
    ...
    def _test_initial_local_settings(self):
        ...
        self.assertEqual(decimal.Decimal("0.8"), self.ad_group.settings.local_b1_sources_group_cpc_cc)
