...
class DirectDealQuerySetTestCase(
    ...
    def _get_model_with_account_scope(self, account: core.models.Account) -> Any:
        return magic_mixer.blend(model.DirectDeal, agency=None, account=account)

    def _get_model_with_agency_scope(self, agency: core.models.Agency) -> Any:
        return magic_mixer.blend(model.DirectDeal, agency=agency, account=None)
