...
class BidModifierTestCase(TestCase):
    ...
    def test_unique_together_with_source_update(self):
        ...
        bid_modifiers.models.BidModifier.objects.update_or_create(
        ...
        self.assertEqual(bid_modifiers.models.BidModifier.objects.filter(ad_group=self.ad_group).count(), 1)
    ...
    def test_bid_modifier_update(self):
        ...
        self.assertEqual(bid_modifiers.BidModifier.objects.filter(ad_group=self.ad_group).count(), 1)
    ...
    def test_publisher_bid_modifier_update(self):
        ...
        with self.assertRaises(bid_modifiers.models.BidModifier.MultipleObjectsReturned):
            bid_modifiers.models.BidModifier.objects.update_or_create(
                defaults={
                    "modifier": 7,
                    "type": bid_modifiers.constants.BidModifierType.PUBLISHER,
