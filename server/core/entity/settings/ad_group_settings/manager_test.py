...
class AdGroupSettingsCreate(TestCase):
    ...
    def test_clone(self):
        ...
        ad_group_settings = model.AdGroupSettings.objects.clone(
            ...
            magic_mixer.blend(core.entity.AdGroup, name='AAAA'),
        ...
        self.assertFalse(ad_group_settings.landing_mode)

        for field in set(model.AdGroupSettings._settings_fields) - {'archived', 'state', 'ad_group_name', 'landing_mode'}:
    ...
    def test_clone_ends_in_past(self):
        ...
        source_ad_group_settings = magic_mixer.blend(model.AdGroupSettings, end_date=end_date)
