...
class CreateContentAd(TestCase):
    ...
    def _blend_a_batch(self):
        ...
        for source in sources:
            ...
            magic_mixer.blend(core.entity.AdGroupSource, ad_group=ad_group, can_manage_content_ads=True, source=source)
    ...
    def test_bulk_clone(self, mock_insert_redirects):
        ...
        content_ads = core.entity.ContentAd.objects.bulk_clone(request, source_content_ads, batch.ad_group, batch)
