...
class TestStatements(TestCase):
    ...
    def test_get_url(self):
        self.assertEqual(
            statements.get_url('test'),
            'https://one.zemanta.com/api/custom_report_download/?path=test',
        )
        self.assertEqual(
            statements.get_url('test test'),
            'https://one.zemanta.com/api/custom_report_download/?path=test+test',
        )
        self.assertEqual(
