...
def discover_localsettings_path(suffix="docker"):
    ...
    localsettings_filename = "{path}/localsettings.py.{env}".format(path=localsettings_path, env=suffix)
    return localsettings_filename


_LOCALSETTINGS_FILENAME = discover_localsettings_path(os.environ.get("CONF_ENV", "docker"))
