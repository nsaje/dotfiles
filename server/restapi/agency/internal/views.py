...
class AgencyViewSet(RESTAPIBaseViewSet):
    ...
    def list(self, request):
        ...
        agencies_user_perm = core.models.Agency.objects.filter_by_user(request.user).distinct()
        agencies_user_perm |= core.models.Agency.objects.filter(account__in=accounts_user_perm).distinct()

        agencies_entity_perm = core.models.Agency.objects.filter_by_entity_permission(
