...
class RESTAPIHelpersTest(TestCase):
    def test_get_applied_deals_dict(self):
        ...
        deal_2 = magic_mixer.blend(core.features.deals.DirectDeal)

        deal_connection_1 = magic_mixer.blend(
            core.features.deals.DirectDealConnection, source=source, adgroup=ad_group, exclusive=True
        )
        deal_connection_1.deals.add(deal_1)
        deal_connection_1.deals.add(deal_2)

        deal_connection_2 = magic_mixer.blend(core.features.deals.DirectDealConnection, source=source, exclusive=False)
        deal_connection_2.deals.add(deal_2)
        ...
        self.assertEqual(
            ...
            [
                ...
                },
                {
                    ...
                    "source": deal_connection_1.source.name,
                    "exclusive": deal_connection_1.exclusive,
                    "description": deal_2.description,
                    "is_applied": True,
                },
                {
