...
class AdGroupDaypartingSerializer(restapi.serializers.base.RESTAPIBaseSerializer):
...
class AdGroupAutopilotSerializer(restapi.serializers.base.RESTAPIBaseSerializer):
    ...
    daily_budget = restapi.fields.BlankDecimalField(
...
class AdGroupSerializer(restapi.common.serializers.PermissionedFieldsMixin,
    ...
    max_cpc = restapi.fields.BlankDecimalField(
        source='local_cpc_cc',
        max_digits=10,
        decimal_places=4,
        allow_null=True,
    ...
    max_cpm = restapi.fields.BlankDecimalField(
