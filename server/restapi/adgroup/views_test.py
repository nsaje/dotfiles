...
class AdGroupsTest(RESTAPITest):
    ...
    def adgroup_repr(
        ...
        representation = {
            ...
            'dailyBudget': Decimal(daily_budget).quantize(Decimal('1.00')) if daily_budget else cls.expected_none_decimal_output,
            ...
            'autopilot': {
                ...
                'dailyBudget': Decimal(autopilot_daily_budget).quantize(Decimal('1.00')) if autopilot_daily_budget else cls.expected_none_decimal_output,
            },
            'dayparting': dayparting,
            'deliveryType': constants.AdGroupDeliveryType.get_name(delivery_type),
            'clickCappingDailyAdGroupMaxClicks': click_capping_daily_ad_group_max_clicks if click_capping_daily_ad_group_max_clicks else cls.expected_none_click_output,
            'clickCappingDailyClickBudget': click_capping_daily_click_budget if click_capping_daily_click_budget else cls.expected_none_click_output,
        }
