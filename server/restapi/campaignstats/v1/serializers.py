...
class CampaignStatsSerializer(rest_framework.serializers.Serializer):
    total_cost = rest_framework.serializers.DecimalField(
        source="local_etfm_cost", max_digits=20, decimal_places=2, rounding=decimal.ROUND_HALF_DOWN
    )
    ...
    cpc = rest_framework.serializers.DecimalField(
        source="local_etfm_cpc", max_digits=5, decimal_places=3, rounding=decimal.ROUND_HALF_DOWN
    )
