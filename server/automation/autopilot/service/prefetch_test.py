...
class AutopilotPrefetchTestCase(TestCase):
    ...
    def setUp(self):
        ...
        redshift_patcher = patch("automation.autopilot.service.prefetch.redshiftapi.api_breakdowns.query")
    ...
    def test_multiple_allrtb(self):
        ...
        expected_data = {
            ...
            ad_group_source2.ad_group: {
                ...
                "old_budget": Decimal("50.00"),
                "spend_perc": 0.0,
                "yesterdays_spend": 0.0,
            },
        }
        self.assertEqual(data[self.ad_group_source.ad_group], expected_data[self.ad_group_source.ad_group])
        self.assertEqual(data[ad_group_source2.ad_group], expected_data[ad_group_source2.ad_group])
