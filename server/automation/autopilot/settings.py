...
CPC_CHANGE_ALLOWED_COMMENTS = [
    cpc_com.CURRENT_CPC_TOO_HIGH,
    cpc_com.CURRENT_CPC_TOO_LOW,
    cpc_com.OVER_SOURCE_MAX_CPC,
    cpc_com.UNDER_SOURCE_MIN_CPC,
    cpc_com.OVER_AD_GROUP_MAX_CPC,
    cpc_com.OVER_AUTOPILOT_MAX_CPC,
    cpc_com.UNDER_AUTOPILOT_MIN_CPC,
    cpc_com.CURRENT_CPC_TOO_HIGH,
    cpc_com.CURRENT_CPC_TOO_LOW,
    cpc_com.OVER_ACCOUNT_SOURCE_MIN_CPC,
    cpc_com.UNDER_ACCOUNT_SOURCE_MIN_CPC,
    cpc_com.OVER_AD_GROUP_SOURCE_MIN_CPC,
    cpc_com.UNDER_AD_GROUP_SOURCE_MIN_CPC,
