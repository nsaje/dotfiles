...
class GetMinimumRemainingBudgetTestCase(TestCase):
    ...
    def test_get_mrb_no_budget_changes(self, mock_datetime):
        ...
        available_tomorrow, max_daily_budget = campaign_stop._get_minimum_remaining_budget(c1)
        self.assertEqual(Decimal('1475'), available_tomorrow)
        self.assertEqual(Decimal('225'), max_daily_budget)
    ...
    def test_get_mrb_one_budget_exhausted(self, mock_datetime):
        ...
        self.assertEqual(Decimal('185'), max_daily_budget)
...
class GetMaximumDailyBudgetTestCase(TestCase):
    ...
    def test_get_max_daily_budget(self):
        ...
        self.assertEqual(Decimal('225'), campaign_stop._get_max_daily_budget(date, c))
    ...
    def test_get_ags_max_daily_budget(self):
        ...
        date = datetime.date(2016, 3, 1)
        self.assertEqual(Decimal('55'), campaign_stop._get_ags_max_daily_budget(date, ags1, ags_settings))
        self.assertEqual(Decimal('50'), campaign_stop._get_ags_max_daily_budget(date, ags2, ags_settings))
        self.assertEqual(Decimal('0'), campaign_stop._get_ags_max_daily_budget(date, ags3, ags_settings))
        self.assertEqual(Decimal('20'), campaign_stop._get_ags_max_daily_budget(date, ags4, ags_settings))
        self.assertEqual(Decimal('100'), campaign_stop._get_ags_max_daily_budget(date, ags5, ags_settings))
