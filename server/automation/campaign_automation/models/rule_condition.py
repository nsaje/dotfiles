...
class RuleCondition(models.Model):
    ...
    left_operand_aggregate_type = models.IntegerField(choices=constants.AggregateType.get_choices())
    ...
    right_operand_aggregate_type = models.IntegerField(choices=constants.AggregateType.get_choices())
    right_operand_window = models.IntegerField(choices=constants.MetricWindow.get_choices())
    right_operand_type = models.IntegerField(choices=constants.MetricType.get_choices())
