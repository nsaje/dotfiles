...
AUTOPILOT_CPC_CHANGE_TABLE = (
    ...
    {'underspend_upper_limit': -0.1, 'underspend_lower_limit': 0, 'bid_cpc_procentual_increase': decimal.Decimal('0')},
    {'underspend_upper_limit': 0, 'underspend_lower_limit': 0.2, 'bid_cpc_procentual_increase': decimal.Decimal('-0.1')}
)
...
AUTOPILOT_OPTIMAL_SPEND = decimal.Decimal('-0.05')
