...
class GauthTestCase(test.TestCase):
    def test_get_flow(self):
        with self.settings(**SETTINGS):
            ...
            expected = 'https://accounts.google.com/o/oauth2/auth?scope=email&redirect_uri=https%3A%2F%2Ftest.zemanta.com%2F&response_type=code&client_id=1111.apps.googleusercontent.com&access_type=online'
