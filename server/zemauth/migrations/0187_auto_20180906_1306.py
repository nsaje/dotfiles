# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-09-06 13:06
...
class Migration(migrations.Migration):
    ...
    dependencies = [("dash", "0342_set_campaign_type"), ("zemauth", "0186_auto_20180816_1010")]
    ...
    operations = [
        migrations.AlterModelOptions(
            ...
            options={
                "permissions": (
                    ...
                    ("fea_can_see_all_sources", "User can see all sources"),
                ),
                "verbose_name": "user",
        ...
        migrations.AddField(
            model_name="user", name="sources", field=models.ManyToManyField(blank=True, to="dash.Source")
        ),
    ]
