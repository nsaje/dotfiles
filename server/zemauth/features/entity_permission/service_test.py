...
class EntityPermissionServiceSetEntityPermissionsTestCase(FutureBaseTestCase):
    def test_is_change_allowed(self):
        ...
        self._test_is_change_allowed_case("account_mgr", None, "agency_mgr", TEST_RESULT_ERROR)
        self._test_is_change_allowed_case("account_mgr", None, "internal_usr", TEST_RESULT_ERROR)
        self._test_is_change_allowed_case("account_mgr", "account_mgr", "account_mgr")
        self._test_is_change_allowed_case("account_mgr", "account_mgr", "agency_mgr", TEST_RESULT_ERROR)
        self._test_is_change_allowed_case("account_mgr", "account_mgr", "internal_usr", TEST_RESULT_ERROR)
        self._test_is_change_allowed_case("account_mgr", "agency_mgr", "account_mgr", TEST_RESULT_ERROR)
        self._test_is_change_allowed_case("account_mgr", "agency_mgr", "agency_mgr", TEST_RESULT_ERROR)
        self._test_is_change_allowed_case("account_mgr", "agency_mgr", "internal_usr", TEST_RESULT_ERROR)
        self._test_is_change_allowed_case("account_mgr", "internal_usr", "account_mgr", TEST_RESULT_ERROR)
        self._test_is_change_allowed_case("account_mgr", "internal_usr", "agency_mgr", TEST_RESULT_ERROR)
        self._test_is_change_allowed_case("account_mgr", "internal_usr", "internal_usr", TEST_RESULT_ERROR)
        ...
        self._test_is_change_allowed_case("agency_mgr", None, "internal_usr", TEST_RESULT_ERROR)
        ...
        self._test_is_change_allowed_case("agency_mgr", "account_mgr", "internal_usr", TEST_RESULT_ERROR)
        ...
        self._test_is_change_allowed_case("agency_mgr", "agency_mgr", "internal_usr", TEST_RESULT_ERROR)
        self._test_is_change_allowed_case("agency_mgr", "internal_usr", "account_mgr", TEST_RESULT_ERROR)
        self._test_is_change_allowed_case("agency_mgr", "internal_usr", "agency_mgr", TEST_RESULT_ERROR)
        self._test_is_change_allowed_case("agency_mgr", "internal_usr", "internal_usr", TEST_RESULT_ERROR)
    ...
    def _test_create_case(self, calling_user_role, requested_user_role):
        ...
        self._test_set_entity_permissions_on_user(
            ...
            expected_result=TEST_RESULT_ERROR,
        )
    ...
    def _test_is_change_allowed_case(
        self, calling_user_role, old_requested_user_role, new_requested_user_role, expected_result=TEST_RESULT_OK
    ):
        self._test_set_entity_permissions_on_user(
            calling_user_role, old_requested_user_role, new_requested_user_role, expected_result=expected_result
        )
    ...
    def _test_change_level_with_disallowed_permissions_case(
        ...
        self._test_set_entity_permissions_on_user(
            ...
            expected_result=TEST_RESULT_OK,
        )
        self._test_set_entity_permissions_on_user(
            calling_user_role,
            old_requested_user_role,
    ...
    def _test_set_entity_permissions_on_user(
        ...
        if expected_result == TEST_RESULT_OK:
