...
def load_data(apps, schema_editor):
    ...
    livestream.recipients = u'operations@zemanta.com, ziga.stopinsek@zemanta.com'
    livestream.save()

    EmailTemplate(
        template_type=EmailTemplateType.DAILY_MANAGEMENT_REPORT,
        subject=u'Daily management report',
        body=u'Please use an email client with HTML support.',
        recipients=u'ziga.stopinsek@zemanta.com, bostjan@zemanta.com, urska.kosec@zemanta.com',
    ).save()
