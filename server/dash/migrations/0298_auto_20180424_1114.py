...
def copy_yahoo_accounts(apps, schema_editor):
    ...
    for yahoo_account in YahooAccount.objects.all():
        account = core.models.Account.objects.get(id=yahoo_account.account_id)
...
class Migration(migrations.Migration):
    ...
    dependencies = [("dash", "0297_auto_20180420_1206")]
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to="dash.YahooAccount"
            ),
        ),
        migrations.RunPython(copy_yahoo_accounts),
        migrations.RemoveField(model_name="yahooaccount", name="account"),
        migrations.AlterField(
            ...
            field=models.PositiveSmallIntegerField(
                ...
                choices=[
                    ...
                    (13, "Campaign switched to landing mode notification"),
                    (14, "Campaign is running out of budget notification"),
                    (15, "Demo is running"),
