...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('dash', '0017_contentadsource_submission_errors'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='action',
            field=models.IntegerField(serialize=False, primary_key=True, choices=[(1, b'Can update state'), (2, b'Can update CPC'), (4, b'Can manage content ads'), (3, b'Can update daily budget')]),
        ),
