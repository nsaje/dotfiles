...
def update_multiple_content_ad_source_states(ad_group_source, content_ad_data):
    ...
    influx.incr('propagation_consistency.content_ad', 1, status='active_nonexisting', media_source=ad_group_source.source.tracking_slug)
    ...
    influx.incr('propagation_consistency.content_ad', 1, status='inconsistent_internal_state', media_source=ad_group_source.source.tracking_slug)
    ...
    if ad_group_source.ad_group.get_current_settings().state == constants.AdGroupSettingsState.ACTIVE:
        ...
        influx.incr('propagation_consistency.content_ad', 1, status='inconsistent_internal_state_active_adgroups', media_source=ad_group_source.source.tracking_slug)
