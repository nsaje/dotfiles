...
class AdGroupSettings(api_common.BaseApiView):
    ...
    def get_dict(self, request, settings, ad_group):
        ...
        result = {
            ...
            "cpc_cc": "{:.4f}".format(settings.local_cpc) if settings.local_cpc is not None else "",
            "max_cpm": "{:.4f}".format(settings.local_cpm) if settings.local_cpm is not None else "",
