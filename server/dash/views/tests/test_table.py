...
class AdGroupPublishersTableTest(TestCase):
    ...
    def test_get(self, mock_query, mock_touchpointconversins_query):
        ...
        mock_stats1 = [{
            ...
            'bounced_visits': 10,
            'non_bounced_visits': 5,
            'avg_cost_per_minute': 0.5,
            'avg_cost_per_pageview': 0.32,
            'avg_cost_per_visit': 0.17,
            'avg_cost_per_non_bounced_visit': 0.22,
            'avg_cost_for_new_visitor': 0.45,
            'click_discrepancy': 3,
            'pageviews': 100,
            'new_visits': 50,
        ...
        expected_row_1 = {
            ...
            'avg_cost_per_non_bounced_visit': 0.22,
            'avg_cost_for_new_visitor': 0.45,
            u'avg_cost_per_pixel_1_24': None,
            u'avg_cost_per_pixel_1_168': None,
            u'avg_cost_per_pixel_1_720': None,
            u'avg_cost_per_pixel_1_2160': None,
            u'avg_cost_per_conversion_goal_2': None,
            u'avg_cost_per_conversion_goal_3': None,
            u'avg_cost_per_conversion_goal_4': None,
            u'avg_cost_per_conversion_goal_5': None,
    ...
    def test_get_filtered_sources(self, mock_active, mock_query, mock_touchpointconversins_query):
        ...
        self.assertDictEqual(result['data']['rows'][0], {
            ...
            u'new_users': 10,
            u'bounced_visits': 10,
            u'non_bounced_visits': 5,
            u'avg_cost_per_minute': 0.5,
            u'avg_cost_per_pageview': 0.32,
            u'avg_cost_per_visit': 0.17,
            u'avg_cost_per_non_bounced_visit': 0.22,
            u'avg_cost_for_new_visitor': 0.45,
            u'avg_cost_per_pixel_1_24': None,
            u'avg_cost_per_pixel_1_168': None,
            u'avg_cost_per_pixel_1_720': None,
            u'avg_cost_per_pixel_1_2160': None,
    ...
    def test_get_outbrain_blacklisted_over_quota(self, mock_query, mock_touchpointconversins_query):
        ...
        expected_row_1 = {
            ...
            u'blacklisted_level': u'account',
            u'blacklisted_level_description': u'Blacklisted in this account',
    ...
    def test_get_reverse_order(self, mock_query, mock_touchpointconversins_query):
        ...
        ad_group = models.AdGroup.objects.get(pk=1)
        pixels = ad_group.campaign.account.conversionpixel_set.exclude(archived=True)
        touchpoint_conversion_goal = ad_group.campaign.conversiongoal_set.filter(
            type=conversions_helper.PIXEL_GOAL_TYPE)[0]
