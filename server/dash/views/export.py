    ...
    def get(self, request, campaign_id):
        ...
        if export_type == 'excel' or export_type == 'excel_detailed':
            ...
            for conversion_goal in conversion_goals:
                columns.append({'key': 'conversion_goal_' + str(conversion_goal.id), 'name': conversion_goal.name})
            ...
            for conversion_goal in conversion_goals:
                fieldnames['conversion_goal_' + str(conversion_goal.id)] = conversion_goal.name
...
class AdGroupAdsPlusExport(ExportApiView):
    ...
    def _add_csv_conversion_goal_columns(self, columns, conversion_goals):
        for conversion_goal in conversion_goals:
            columns['conversion_goal_' + str(conversion_goal.id)] = conversion_goal.name
