    ...
    def get_rows(
        ...
        for source in sources:
            ...
            if ad_group_level:
                ...
                if user.has_perm('zemauth.set_ad_group_source_settings') and row['can_update_cpc']:
                ...
                if user.has_perm('zemauth.set_ad_group_source_settings') and row['can_update_daily_budget']:
