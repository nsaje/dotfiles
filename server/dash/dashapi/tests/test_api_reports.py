...
ACCOUNT_1 = {
    'account': 'test account 1', 'agency_id': '',
...
CAMPAIGN_1 = {
    ...
    'campaign_id': 1, 'archived': False, 'name': 'test campaign 1', 'status': 'ACTIVE',
...
CAMPAIGN_2 = {
    ...
    'campaign_id': 2, 'archived': True, 'name': 'test campaign 2', 'status': 'PAUSED',
...
AD_GROUP_1 = {
    ...
    'ad_group_id': 1, 'archived': False, 'name': 'test adgroup 1', 'status': 'ENABLED', 'state': 1,
}
AD_GROUP_2 = {
    'ad_group': 'test adgroup 2',
    'ad_group_id': 2, 'archived': False, 'name': 'test adgroup 2', 'status': 'PAUSED', 'state': 2
}
