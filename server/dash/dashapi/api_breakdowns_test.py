...
ACCOUNT_1 = {
    'account_id': 1, 'agency_id': None, 'archived': False, 'name': 'test account 1', 'status': 1,
...
CAMPAIGN_1 = {
    'campaign_id': 1, 'account_id': 1, 'agency_id': None, 'archived': False,
    'name': 'test campaign 1', 'status': 1, 'campaign_manager': 'supertestuser@test.com',
    'pacing': None, 'allocated_budgets': None, 'spend_projection': None, 'license_fee_projection': None,
}
CAMPAIGN_2 = {
    'campaign_id': 2, 'account_id': 1, 'agency_id': None, 'archived': True,
    'name': 'test campaign 2', 'status': 2, 'campaign_manager': 'mad.max@zemanta.com',
    'pacing': None, 'allocated_budgets': None, 'spend_projection': None, 'license_fee_projection': None,
}

AD_GROUP_1 = {
    'ad_group_id': 1, 'campaign_id': 1, 'account_id': 1, 'agency_id': None,
    'archived': False, 'name': 'test adgroup 1', 'status': 1, 'state': 1
}
AD_GROUP_2 = {
    'ad_group_id': 2, 'campaign_id': 1, 'account_id': 1, 'agency_id': None,
