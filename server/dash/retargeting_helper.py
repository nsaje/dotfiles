...
def can_add_source_with_retargeting(source, ad_group_settings):
    ...
    """
    if (
        not ad_group_settings.retargeting_ad_groups
        and not ad_group_settings.exclusion_retargeting_ad_groups
        and not ad_group_settings.audience_targeting
        and not ad_group_settings.exclusion_audience_targeting
    ):
        return True
    return source.can_modify_retargeting_automatically() or source.can_modify_retargeting_manually()
...
def can_add_sources_with_retargeting(sources, ad_group_settings):
    ...
    for source in sources:
        if not (source.can_modify_retargeting_automatically() or source.can_modify_retargeting_manually()):
            return False
    return True
