...
class Command(utils.command_helpers.ExceptionCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('--column', dest='column',
                            default='content_ad_id', help='Lookup column in CSV')
        parser.add_argument('--level', dest='level', default='content_ad',
                            help='Lookup level ("content_ad", "ad_group", ...)')
        parser.add_argument('--verbose', dest='verbose', default=False, action='store_true')
        parser.add_argument('source', type=str, help='Source slug')
        parser.add_argument('state', type=str, default='block', help='Filter state',
