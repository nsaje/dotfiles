...
class Command(Z1Command):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            "--adgroups", metavar="ADGROUPS", nargs="+", help="A list of Ad Group IDs. Separated with spaces."
        )
    ...
    def handle(self, *args, **options):
        ...
        for ad_group in ad_groups:
            ...
            for diff_key in KEYS_TO_CHECK_ADGROUP:
                ...
                if (
                    not redirector and not eins
                ):  # in case of omitempty on r1 fields with empty strings will be stored as None
                    continue
                if redirector != eins:
