...
class Command(ExceptionCommand):
    ...
    def handle(self, *args, **options):
        ...
        for history_model in history_models:
            self._change_ids_in_history_model_subclass(
                user, deleted_user, history_model, relation_names)
    ...
    def _change_ids_and_text_in_history(self, user, deleted_user, relation_names):
        ...
        for history in core.history.History.objects.all().iterator():
            ...
            if user.get_full_name():
                history.changes_text = history.changes_text.replace(
                    user.get_full_name(), deleted_user.get_full_name())
