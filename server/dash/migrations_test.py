...
class ContentAdBatchMigrationTest(MigrationTest):
    ...
    def test_migration(self):
        ...
        batch = UploadBatch.objects.create(
            name="test", display_url="abc.com", brand_name="Brand inc.", description="This desc!", call_to_action="Act!"
        )
        content_ad1 = ContentAd(url="test.com", title="test", ad_group_id=ad_group.id, batch_id=batch.id)
        content_ad1.save()
