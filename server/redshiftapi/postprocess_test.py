...
class PostprocessGoalsTest(TestCase):
    ...
    def test_apply_conversion_goal_columns(self):
        rows = [
            {
                'campaign_id': 1, 'ad_group_id': 1, 'clicks': 1, 'e_media_cost': 10, 'local_e_media_cost': 20,
                'media_cost': 10, 'local_media_cost': 20, 'etfm_cost': 10, 'local_etfm_cost': 20,
                'et_cost': 10, 'local_et_cost': 20
            },
            {
                'campaign_id': 1, 'ad_group_id': 2, 'clicks': 1, 'e_media_cost': 20, 'local_e_media_cost': 40,
                'media_cost': 20, 'local_media_cost': 40, 'etfm_cost': 20, 'local_etfm_cost': 40,
                'et_cost': 20, 'local_et_cost': 40
            },
        ]
    ...
    def test_apply_conversion_goal_columns_totals(self):
        rows = [{
            'clicks': 1, 'e_media_cost': 10, 'local_e_media_cost': 20, 'media_cost': 10, 'local_media_cost': 20,
            'etfm_cost': 10, 'local_etfm_cost': 20, 'et_cost': 10, 'local_et_cost': 20
        }]
