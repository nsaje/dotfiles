...
class PostprocessGoalsTest(TestCase):
    ...
    def test_apply_conversion_goal_columns(self):
        rows = [
            {'campaign_id': 1, 'ad_group_id': 1, 'clicks': 1, 'e_media_cost': 10, 'media_cost': 10, 'etfm_cost': 10, 'et_cost': 10},  # noqa
            {'campaign_id': 1, 'ad_group_id': 2, 'clicks': 1, 'e_media_cost': 20, 'media_cost': 20, 'etfm_cost': 20, 'et_cost': 20},  # noqa
        ]
    ...
    def test_apply_conversion_goal_columns_totals(self):
        rows = [
            {'clicks': 1, 'e_media_cost': 10, 'media_cost': 10, 'etfm_cost': 10, 'et_cost': 10}
        ]
            ...
            rows, [
                {
                    ...
                    'etfm_roas_pixel_1_168': 200.0 - 10,
                    'pixel_1_720': 22,
                    ...
                    'etfm_roas_pixel_1_720': 200.0 - 10,
                    'pixel_1_2160': 22,
                    ...
                    'etfm_roas_pixel_1_2160': 200.0 - 10,
                    'ad_group_id': 1,
                    'campaign_id': 1,
                    'e_media_cost': 10,
                    'et_cost': 10,
                ...
                },
                {
                    ...
                    'etfm_roas_pixel_1_168': 300.0 - 20,
                    'pixel_1_720': 33,
                    ...
                    'etfm_roas_pixel_1_720': 300.0 - 20,
                    'pixel_1_2160': 77,
                    ...
                    'etfm_roas_pixel_1_2160': 700.0 - 20,
                    'ad_group_id': 2,
                    'campaign_id': 1,
                    'e_media_cost': 20,
                    'et_cost': 20,
            ...
            rows, [
                {
                    ...
                    'etfm_roas_pixel_1_168': 500.0 - 10,
                    'pixel_1_720': 55,
                    ...
                    'etfm_roas_pixel_1_720': 500.0 - 10,
                    'pixel_1_2160': 99,
                    ...
                    'etfm_roas_pixel_1_2160': 900.0 - 10,
                    'e_media_cost': 10,
                    'media_cost': 10,
                    'etfm_cost': 10,
                    'et_cost': 10,
