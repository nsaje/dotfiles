...
class QueryTest(TestCase):
    ...
    def test_query_all_depth_3(self, mock_query, _):
        ...
        self.assertCountEqual(rows, [
            ...
            {'campaign_id': 1, 'ad_group_id': 2, 'dma': 502, 'clicks': 4, 'yesterday_cost': 0, 'e_yesterday_cost': 0},
            # {'campaign_id': 2, 'ad_group_id': 3, 'dma': 501, 'clicks': 5, 'yesterday_cost': 0, 'e_yesterday_cost': 0},
            {'campaign_id': 2, 'ad_group_id': 3, 'dma': 502, 'clicks': 6, 'yesterday_cost': 0, 'e_yesterday_cost': 0},
            # {'campaign_id': 2, 'ad_group_id': 4, 'dma': 501, 'clicks': 7, 'yesterday_cost': 0, 'e_yesterday_cost': 0},
            {'campaign_id': 2, 'ad_group_id': 4, 'dma': 502, 'clicks': 8, 'yesterday_cost': 0, 'e_yesterday_cost': 0},
        ])
    ...
    def test_remove_postclicks(self, mock_query, _):
        ...
        self.assertCountEqual(rows, [
            ...
            {'campaign_id': 1, 'ad_group_id': 2, 'dma': 502, 'clicks': 4, 'yesterday_cost': 0, 'e_yesterday_cost': 0, 'new_users': None},  # noqa
            {'campaign_id': 2, 'ad_group_id': 3, 'dma': 501, 'clicks': 5, 'yesterday_cost': 0, 'e_yesterday_cost': 0, 'new_users': None},  # noqa
            {'campaign_id': 2, 'ad_group_id': 3, 'dma': 502, 'clicks': 6, 'yesterday_cost': 0, 'e_yesterday_cost': 0, 'new_users': None},  # noqa
            {'campaign_id': 2, 'ad_group_id': 4, 'dma': 501, 'clicks': 7, 'yesterday_cost': 0, 'e_yesterday_cost': 0, 'new_users': None},  # noqa
            {'campaign_id': 2, 'ad_group_id': 4, 'dma': 502, 'clicks': 8, 'yesterday_cost': 0, 'e_yesterday_cost': 0, 'new_users': None},  # noqa
        ])
    ...
    def test_postprocess_time(self, mock_query, _):
        ...
        self.assertEqual(rows, [
            {'campaign_id': 1, 'day': datetime.date(2016, 10, 3), 'clicks': 3, 'yesterday_cost': 0, 'e_yesterday_cost': 0},  # noqa
            {'campaign_id': 1, 'day': datetime.date(2016, 10, 1), 'clicks': 1, 'yesterday_cost': 0, 'e_yesterday_cost': 0},  # noqa
