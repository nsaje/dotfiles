...
class QuickstatsTest(TestCase):
    ...
    def test_query_campaign(self, mock_prepare_query_all_base, _):
        ...
        expected_constraints = {"campaign_id": 608, "date__gte": date_from, "date__lte": date_to}
        mock_prepare_query_all_base.assert_called_with(
            breakdown=[], constraints=expected_constraints, parents=None, use_publishers_view=False
        )
    ...
    def test_query_adgroup(self, mock_prepare_query_all_base, _):
        ...
        expected_constraints = {"ad_group_id": 2040, "date__gte": date_from, "date__lte": date_to, "source_id": 3}
        mock_prepare_query_all_base.assert_called_with(
            breakdown=[], constraints=expected_constraints, parents=None, use_publishers_view=False
        )
