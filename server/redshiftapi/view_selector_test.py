...
class ViewSelectorTest(TestCase):
    ...
    def test_get_best_view_conversions(self):
        ...
        self.assertEqual(view_selector.get_best_view_conversions(['account_id', 'source_id']), 'mv_account_conv')  # noqa
        ...
        self.assertEqual(view_selector.get_best_view_conversions(['account_id', 'campaign_id']), 'mv_campaign_conv')  # noqa
        self.assertEqual(view_selector.get_best_view_conversions(['account_id', 'ad_group_id']), 'mv_adgroup_conv')  # noqa

        self.assertEqual(view_selector.get_best_view_conversions(['campaign_id', 'month']), 'mv_campaign_conv')
        self.assertEqual(view_selector.get_best_view_conversions(['campaign_id', 'source_id']), 'mv_campaign_conv')  # noqa
        ...
        self.assertEqual(view_selector.get_best_view_conversions(['campaign_id', 'ad_group_id']), 'mv_adgroup_conv')  # noqa
        self.assertEqual(view_selector.get_best_view_conversions(['campaign_id', 'content_ad_id']), 'mv_contentad_conv')  # noqa

        self.assertEqual(view_selector.get_best_view_conversions(['ad_group_id', 'month']), 'mv_adgroup_conv')  # noqa
        self.assertEqual(view_selector.get_best_view_conversions(['ad_group_id', 'source_id']), 'mv_adgroup_conv')  # noqa
        ...
        self.assertEqual(view_selector.get_best_view_conversions(['ad_group_id', 'content_ad_id']), 'mv_contentad_conv')  # noqa

        self.assertEqual(view_selector.get_best_view_conversions(['ad_group_id', 'publisher_id']), 'mv_conversions')  # noqa
        self.assertEqual(view_selector.get_best_view_conversions(['ad_group_id', 'publisher_id', 'dma']), None)
        self.assertEqual(view_selector.get_best_view_conversions(['ad_group_id', 'content_ad_id', 'publisher_id']), 'mv_conversions')  # noqa

        self.assertEqual(view_selector.get_best_view_conversions(['content_ad_id', 'month']), 'mv_contentad_conv')  # noqa
        self.assertEqual(view_selector.get_best_view_conversions(['content_ad_id', 'source_id']), 'mv_contentad_conv')  # noqa
        ...
        self.assertEqual(view_selector.get_best_view_conversions(['content_ad_id', 'publisher_id']), 'mv_conversions')  # noqa
    ...
    def test_get_best_view_touchpoints(self):
        ...
        self.assertEqual(view_selector.get_best_view_touchpoints(['ad_group_id', 'publisher_id', 'dma']), 'mv_touchpointconversions')  # noqa
    ...
    def test_supports_external_id(self):
        ...
        self.assertTrue(view_selector.supports_external_id('mv_master_pubs'))
        self.assertTrue(view_selector.supports_external_id('mv_adgroup_pubs'))
        self.assertTrue(view_selector.supports_external_id('mv_campaign_pubs'))
        self.assertTrue(view_selector.supports_external_id('mv_account_pubs'))

        self.assertFalse(view_selector.supports_external_id('mv_adgroup'))
        self.assertFalse(view_selector.supports_external_id('mv_campaign'))
        self.assertFalse(view_selector.supports_external_id('mv_account'))
