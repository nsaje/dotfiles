...
class Command(ExceptionCommand):
    help = "Aggregate inventory data for last 30 days from supply_stats table and save processed data to inventory table"

    def add_arguments(self, parser):
        parser.add_argument(
            '--date_from',
            help='Iso formatted date. Date from which supply stats should be aggregated.')
        parser.add_argument(
            '--date_to',
            help='Iso formatted date. Date to which supply stats should be aggregated.')
