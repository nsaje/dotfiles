...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        statsd_helper.statsd_gauge('hours_oldest_cmd_waiting', hours_oldest_manual_cmd_waiting)

        hours_oldest_auto_cmd_waiting = api.age_oldest_waiting_action(manual_action=False)
        statsd_helper.statsd_gauge('hours_oldest_auto_cmd_waiting', hours_oldest_auto_cmd_waiting)
