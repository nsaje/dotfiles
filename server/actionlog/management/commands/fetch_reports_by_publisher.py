...
from utils.command_helpers import parse_date, parse_id_list, get_ad_group_sources
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if from_date > till_date:
            logger.info('Unable to fetch reports by publisher. from_date should be less than or equal to till_date.')
            return
        ...
        for ad_group_source in ad_group_sources:
            ...
            ad_group_source_sync.trigger_reports_by_publisher_for_dates(dates)
