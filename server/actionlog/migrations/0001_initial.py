    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.CharField(max_length=100, choices=[(b'get_reports', b'Get reports'), (b'set_property', b'Set property'), (b'stop_campaign', b'Stop campaign'), (b'get_campaign_status', b'Get campaign status')])),
